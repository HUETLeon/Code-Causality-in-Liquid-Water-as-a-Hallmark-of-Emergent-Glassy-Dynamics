...
def main():
    ...
    u = mda.Universe(f'conf.gro', 
                     f'PLUMED_INIT_CONF/frames_seed{seed}.xtc')
    ...
    for traj_number, central in zip(frame_numbers, center_indexs):
        ...
        pickle.dump([0.1*dipole_central[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_1stshell[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_2ndshell[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_total[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_total_corrected[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_out_1stshell[traj_number:traj_number+frame_numbers[0]][::stepsize], 0.1*dipole_out_2ndshell[traj_number:traj_number+frame_numbers[0]][::stepsize]], 
