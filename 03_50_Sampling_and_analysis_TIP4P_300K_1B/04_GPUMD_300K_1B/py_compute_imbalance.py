...
def construct_Xt_Yt(Ntrajs, seed, t, E, tau_e, njobs, stds, Trajnumbers):
    ...
    (dipoles_center_t, dipoles_1stshell_t, dipoles_2ndshell_t, dipoles_total_t, dipoles_total_corrected_t, dipole_out_1stshell_t, dipole_out_2ndshell_t ) = (
        np.swapaxes(Parallel(n_jobs=njobs)(delayed(read_files_dipole)
            (namefile=f'./pickles_dipoles/dipoles_cent_1st_2nd_total_totalc_out1st_out2nd_seed{seed}_traj{traj_number}.p', 
                t=t, E=E, tau_e=tau_e, stds=stds) for traj_number in Trajnumbers), axis1=0, axis2=1)
    )
...
def main():
    ...
    Trajnumbers = np.loadtxt("Datatrajs_frame_numbers.txt", dtype='int')
    k = 20
    ...
    stds = compute_scaling_factors(f'./pickles_dipoles/dipoles_cent_1st_2nd_total_totalc_out1st_out2nd_seed1_traj4997.p')
    ...
    (dipoles_center_t0, 
        ...
        construct_Xt_Yt(Ntrajs=Ntrajs, seed=args.seed, t=t0, E=E, tau_e=tau_e, njobs=njobs, stds=stds, Trajnumbers=Trajnumbers) 
    )
    ...
    for tau in tqdm(taus):
        ...
        (dipoles_center_tau, 
            ...
            construct_Xt_Yt(Ntrajs=Ntrajs, seed=args.seed, t=t0+tau, E=E, tau_e=tau_e, njobs=njobs, stds=stds, Trajnumbers=Trajnumbers) 
        )
