...
def read_files_dipole(namefile, t, E, tau_e, stds):
    ...
    dipoles_center_temp, dipoles_1stshell_temp, dipoles_2ndshell_temp, dipoles_total_temp, dipoles_totalc_temp = pickle.load(open(namefile, 'rb'))
...
def compute_scaling_factors(namefile):
    ...
    dipoles_center, dipoles_1stshell, dipoles_2ndshell , dipoles_total, dipoles_totalc = pickle.load(open(namefile, 'rb'))
...
def construct_Xt_Yt(Ntrajs, seed, t, E, tau_e, njobs, stds):
    ...
    assert len(stds) == 5, "Error: wrong number of stds"
    (dipoles_center_t, dipoles_1stshell_t, dipoles_2ndshell_t, dipoles_total_t, dipoles_total_corrected_t ) = (
    ...
    return dipoles_center_t, dipoles_1stshell_t, dipoles_2ndshell_t, dipoles_total_t, dipoles_total_corrected_t
...
def main():
    ...
    # construct X0 and Y0
    dipoles_center_t0, dipoles_1stshell_t0, dipoles_2ndshell_t0, dipoles_total_t0, dipoles_total_corrected_t0 = (
    ...
    for tau in tqdm(taus):
        ...
        dipoles_center_tau, dipoles_1stshell_tau, dipoles_2ndshell_tau , dipoles_total_tau, dipoles_total_corrected_tau = (
