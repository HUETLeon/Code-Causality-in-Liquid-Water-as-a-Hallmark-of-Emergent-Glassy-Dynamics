...
def main():
    ...
    dipole_central_cor_std = dipole_central_cor.std(axis=1)/np.sqrt(50)
    dipole_1stshell_cor_std = dipole_1stshell_cor.std(axis=1)/np.sqrt(50)
    dipole_2ndshell_cor_std = dipole_2ndshell_cor.std(axis=1)/np.sqrt(50)
