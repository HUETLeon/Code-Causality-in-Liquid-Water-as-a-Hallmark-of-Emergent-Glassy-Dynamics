...
def main():
    ...
    stepjump           = 10 # (na)  Number of step to jumps from main traj to data trajs
    DataTraj_Timestep  = Main_Traj_Timestep * stepjump # 100ps
    Ndatatraj = 1000 # Number of pieces of traj to generate
    Frst_frame  = 20000 # 200ns   # Number of inital Frame of the Main Traj to Ingnore for convergeance
    ...
    Datatraj_Steps = (Nframes - DataTraj_length* stepjump - Frst_frame) // Ndatatraj
    Datatraj_Size = DataTraj_length * stepjump
    ...
    for traj_number, central in zip(inital_frames_numbers, center_indexs):
        ...
        pickle.dump([d_central[traj_number:traj_number+Datatraj_Size][::stepjump],
                     d_1stshell[traj_number:traj_number+Datatraj_Size][::stepjump],
                     d_2ndshell[traj_number:traj_number+Datatraj_Size][::stepjump],
                     ],
