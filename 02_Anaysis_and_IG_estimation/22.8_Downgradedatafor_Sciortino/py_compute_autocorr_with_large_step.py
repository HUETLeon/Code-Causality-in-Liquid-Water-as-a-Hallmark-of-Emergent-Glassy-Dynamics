...
def main():
    ...
    for seed in tqdm(range(Nseed)):
        time, dipole_central_cor[:,seed] = autocorrelation_1d( dipole_central[:,seed][::stepjump], timestep = timesetp * stepjump, cutoff= Correlation_size)
        time, dipole_1stshell_cor[:,seed] = autocorrelation_1d( dipole_1stshell[:,seed][::stepjump], timestep = timesetp * stepjump, cutoff= Correlation_size)
        time, dipole_2ndshell_cor[:,seed] = autocorrelation_1d( dipole_2ndshell[:,seed][::stepjump], timestep = timesetp * stepjump, cutoff= Correlation_size)
