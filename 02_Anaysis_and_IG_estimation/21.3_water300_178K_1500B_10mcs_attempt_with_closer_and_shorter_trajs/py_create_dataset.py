...
def main():
    ...
    DataTraj_Timestep  = Main_Traj_Timestep * stepjump # 20ps
    ...
    Overlap = 6 # mutiplicator of Datatraj_Size after defining inital_frames_numbers : def value is 1 
    ...
    Datatraj_Size = (Nframes - Frst_frame) // (Ndatatraj + Overlap)
    inital_frames_numbers = np.arange(Ndatatraj) * Datatraj_Size + Frst_frame
    ...
    Datatraj_Size = Datatraj_Size * Overlap
