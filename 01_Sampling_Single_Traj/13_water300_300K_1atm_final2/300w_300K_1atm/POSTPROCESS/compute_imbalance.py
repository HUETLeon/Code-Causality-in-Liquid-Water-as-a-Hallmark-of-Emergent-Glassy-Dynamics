...
def construct_Xt_Yt(Ntrajs, seed, t, E, tau_e, njobs, stds):
    ...
    (dipoles_center_t, dipoles_1stshell_t, dipoles_2ndshell_t) = (
        np.swapaxes(Parallel(n_jobs=njobs)(delayed(read_files_dipole)
            (namefile=f'./pickles_dipoles/dipoles_cent_1st_2nd_seed{seed}_traj{(traj_number*10000)+5000}.p', 
...
def main():
    ...
    stds = compute_scaling_factors(f'./pickles_dipoles/dipoles_cent_1st_2nd_seed1_traj5000.p')
